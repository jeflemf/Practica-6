...
String contrasenaCerradura = "152006*";   //Variable donde almaceno la contraseña definida por el sistema
...
void setup()
{
  ...
  OFF(led_rojo);                   //enciendo el led rojo
